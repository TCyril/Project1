                            ...
                            <div className="space-y-6 justify-center">
                                <div className="flex items-start space-x-4">
                                    ...
                                    <div>
                                        ...
                                        <a href="mailto:nguyenducthang899@gmail.com" className="text-muted-foreground hover:text-primary transition-colors">
                                            nguyenducthang899@gmail.com
                                        </a>
                                    </div>
                                </div>
                                ...
                                <div className="flex items-start space-x-4">
                                    ...
                                    <div>
                                        ...
                                        <a href="tel:+84963710748" className="text-muted-foreground hover:text-primary transition-colors">
                                            +84 963 710 748
                                        </a>
                                    </div>
                                </div>
                            ...
                            <form className="space-y-6">
                                ...
                                <div>
                                    ...
                                    <textarea 
                                        ...
                                        name="message"
                                        required
                                        className="w-full px-4 py-3 rounded-md border border-input bg-background focus:underline-hidden focus:ring-2 focus:ring-primary resize-none"
                                        placeholder="Hello..."
                                     />
                                </div>
